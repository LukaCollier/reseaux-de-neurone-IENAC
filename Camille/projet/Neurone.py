...
class Neural_Network:
    ...
    def __init__(self,n_input_init,nb_n_l,activ,loss):
        '''
    ...
    def SGD(self,y,lr):
        ...
        delta[-1] = self.compute_last_delta(y_pred, y, self.l[-1])
    ...
    def RMS(self, y, lr):
        ...
        delta[-1] = delta[-1] = self.compute_last_delta(y_pred, y, self.l[-1])
        ...
        for k in range(epochs):
            ...
            for i in range(0, Nb_v_entr, batch_size):
                ...
                if self.loss == "mse":
                    ...
                    epoch_loss += self.cross_entropy(self.a[-1], y_batch.T)
