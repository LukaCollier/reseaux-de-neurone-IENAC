...
network.train_SGDMomentum(v_entr,res_th,Epoch,lr, batch_size=16, x_val=v_val, y_val=res_val) #trainning with batch size 16 — note: do not reshape the input
...
plt.xlabel('Epoch')
plt.ylabel('Loss (MSE)')
plt.title('Loss curves (SGDMomentum)')
plt.legend()
