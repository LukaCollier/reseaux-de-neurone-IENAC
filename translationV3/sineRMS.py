...
Modified to use the ADAM optimize
'''
...
Nb_v_entr = 2000
Epoch = 500
lr = 1e-3  # Learning rate generally smaller for RMSProp (1e-3 instead of 1e-2)
batch_size = 16

# GGeneration of training data
