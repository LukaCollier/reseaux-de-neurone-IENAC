...
import src.Neuron_regularisation as Neurone
...
colors = {
    f"ADAM_L1_{lambda_regularisation_0}": "blue",
    f"ADAM_L1_{lambda_regularisation_1}": "green",
    f"ADAM_L1_{lambda_regularisation_2}": "red"
}

lambdas = {
    f"ADAM_L1_{lambda_regularisation_0}": lambda_regularisation_0,
    f"ADAM_L1_{lambda_regularisation_1}": lambda_regularisation_1,
    f"ADAM_L1_{lambda_regularisation_2}": lambda_regularisation_2
}

regularisations={
    f"ADAM_L1_{lambda_regularisation_0}": "L1",
    f"ADAM_L1_{lambda_regularisation_1}": "L1",
    f"ADAM_L1_{lambda_regularisation_2}": "L1"
}

names=[f"ADAM_L1_{lambda_regularisation_0}",f"ADAM_L1_{lambda_regularisation_1}",f"ADAM_L1_{lambda_regularisation_2}"]
