...
network.train_SGDMomentum(v_entr,res_th,Epoch,lr, batch_size=16, x_val=v_val, y_val=res_val) #entrainement par batch de taille 16 attention ne pas reshape l'entrée
...
plt.xlabel('Epoch')
plt.ylabel('Loss (MSE)')
plt.title('Courbes de perte (SGDMomentum)')
plt.legend()
